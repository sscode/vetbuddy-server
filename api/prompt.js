...
const textPromptEnd = `
    ...
    If there is any information missing, write nothing except for the section name, except in the case of sections marked **SPECIAL INSTRUCTIONS**. Do not include anything is unrelated to the reason for the visit and does not provide any medical information about the animal.
